...
const size_t BATCH_SIZE = 10;  // Set the batch size according to your requirements
...
void message_processor() {
    while (running) {
        ...
        // Pop messages from the queue up to BATCH_SIZE
        ...
        //    {
        //     std::cout<<" batch:  " << batch[i]<<std::endl;
        //    }
        }
    }
}
